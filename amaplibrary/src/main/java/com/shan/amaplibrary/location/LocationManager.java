...
import com.shan.amaplibrary.utils.LocationUtils;

/**
 * Created by chenjunshan on 17-2-6.
 */
...
public class LocationManager {
            ...
            if (null != location) {
                ...
                if (location.getErrorCode() == 0) {
                    ...
                    if (mLocationListener != null)
                        mLocationListener.locationSuccess(location);
                } else {
                    if (mLocationListener != null)
                        mLocationListener.locationFailure();
                }
            } else {
                if (mLocationListener != null)
                    mLocationListener.locationFailure();
     ...
     * @since 2.8.0
     */
    public void startLocation(LocationListener mLocationListener) {
